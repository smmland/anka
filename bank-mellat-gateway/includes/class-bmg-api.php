...
class BMG_API {
	...
	public static function get_error_message( $code ) {
		$messages = array(
			...
			'412' => __( 'شناسه قبض نادرست است.', 'bank-mellat-gateway' ),
			'413' => __( 'شناسه پرداخت نادرست است.', 'bank-mellat-gateway' ),
			'414' => __( 'سازمان صادرکننده قبض نامعتبر است.', 'bank-mellat-gateway' ),
			'415' => __( 'زمان جلسه کاری به پایان رسیده است.', 'bank-mellat-gateway' ),
			'416' => __( 'خطا در ثبت اطلاعات.', 'bank-mellat-gateway' ),
			'417' => __( 'شناسه پرداخت‌کننده نامعتبر است.', 'bank-mellat-gateway' ),
			'418' => __( 'اشکال در تعریف اطلاعات مشتری.', 'bank-mellat-gateway' ),
			'419' => __( 'تعداد دفعات ورود اطلاعات از حد مجاز گذشته است.', 'bank-mellat-gateway' ),
			'421' => __( 'آی‌پی سرور برای این ترمینال در بانک ملت نامعتبر یا ثبت‌نشده است.', 'bank-mellat-gateway' ),
